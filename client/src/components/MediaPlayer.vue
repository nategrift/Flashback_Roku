<template>
    <div class="video-player" ref="fullPlayer" @keyup="keypress">
        <video
        ...
        ></video>
        <div class="controls">
            <input type="range" min="0" max="1000" value="0" class="slider" ref="timeSlider" @input="() => changeTime()">
            <div class="controls-bottom">
                <div class="controls-bottom__left">
                    <button @click="togglePlaying" ref="button" title="Toggle Playing Video (Space)">Play</button>
                    <button @click="() => changeTime(-10)" title="Go backwards 10 seconds (Left Arrow)">-10s</button>
                    <button @click="() => changeTime(10)" title="Fast farward 10 seconds (Right Arrow)">+10s</button>
                    <button @click="toggleVolume">Volume</button>
                    <div class="volumeControl">
                      <input type="range" min="0" max="100" value="50" class="slider" ref="volumeSlider" @input="setVolume" @change="setVolume">
                    </div>
                    <!-- <p>Hercules</p> -->
                </div>
        ...
        keypress(e) {
          ...
          switch(e.keyCode) {
            ...
            case 39:
              ...
              break;
            case 38:
              this.$refs.volumeSlider.value = parseInt(this.$refs.volumeSlider.value) + 10;
              break;
            case 40:
              this.$refs.volumeSlider.value = parseInt(this.$refs.volumeSlider.value) - 10;
              break;
